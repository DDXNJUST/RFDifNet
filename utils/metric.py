...
def ssim_one_image(img_gt, img_test, channel_axis=0):
    ...
    # pdb.set_trace()
    # return structural_similarity(img_gt[-1, :, :], img_test[-1, :, :], channel_axis=channel_axis)
    return structural_similarity(img_gt[-1, :, :], img_test[-1, :, :], channel_axis=channel_axis, data_range=img_gt.max()-img_gt.min())
